## Setup
Renomeie **.env.example** para **.env** e adicione seu [github TOKEN](https://github.com/settings/tokens) na variável ambiente TOKEN e seu github EMAIL na variável ambiente USER</p>  
